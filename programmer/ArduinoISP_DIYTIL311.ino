// ArduinoISP (Modified to program and test the DIYTIL311 specifically)
...
void testDisplay(){
	...
	// Test the entirety of the DIYTIL311
...
void loop(void) {
  ...
  // for DIYTIL311
  else if(pmode == 0 && testD == 1 && error == 0){
	testDisplay();
  }
}
