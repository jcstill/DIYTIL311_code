...
atmega328p 32 TQFP/MLF Package
// Pin						Connection				Code
// ----------------------- -----------------------	--------------------------------------------------
// // PortD
...
PB0						EX_PIN_DI-D				PINB	=	(0x01)	|	(0b00000001)	|	(1<<0)
PB1						EX_PIN_DI-C				PINB	=	(0x02)	|	(0b00000010)	|	(1<<1)
PB2						EX_PIN_BLNK				PINB	=	(0x20)	|	(0b00100000)	|	(1<<5)
PB3						EX_PAD_MOSI				PINB	=	(0x04)	|	(0b00000100)	|	(1<<2)
PB4						EX_PAD_MISO				PINB	=	(0x08)	|	(0b00001000)	|	(1<<3)
PB5						EX_PAD_SCK				PINB	=	(0x10)	|	(0b00010000)	|	(1<<4)
// PortC
PC0						LED_ROW_1				PORTC	=	(0x01)	|	(0b00000001)	|	(1<<0)
PC1						LED_ROW_3				PORTC	=	(0x02)	|	(0b00000010)	|	(1<<1)
PC2						LED_ROW_5				PORTC	=	(0x04)	|	(0b00000100)	|	(1<<2)
